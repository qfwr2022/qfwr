...
#' it is necessary that the server function `submission_server()` be 
...
#' `submission_ui()` shall _not_ be included in an R chunk with a 
#' `context="server"`.
#' 
#' * `submission_server`
#' 
...
# Decode and extract a hashed column in a data.frame
# 
